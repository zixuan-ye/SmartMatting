...
class MattingCriterion(nn.Module):
    ...
    def known_l1_loss(self, sample_map, preds, targets):
        ...
        if torch.sum(new_sample_map) == 0:
            ...
            scale = new_sample_map.shape[0]*200704/torch.sum(new_sample_map)
        # scale = 1
    ...
    def forward(self, sample_map, preds, targets):
        ...
        for k in self.losses:
            if k=='unknown_l1_loss' or k=='known_l1_loss' or k=='loss_gradient_penalty' or k=='trans_loss' or k=='trans_loss_seg':
